...
<body>
	...
	<table style="display:inline-table;width: 200px">
		<tr>
			<td>
			<img style="width: 100%" src="<?=$fetchProduct["productImage"]?>">
			</td>
		</tr>
		<tr>
			<td>
				<strong><?=$fetchProduct["productName"]?></strong >
				<br>IDR <?=number_format($fetchProduct["productPrice"])?>
				<br>
				<?=$fetchProduct["productDesc"]?>
			</td>
		</tr> 
		<tr>
			<td>
